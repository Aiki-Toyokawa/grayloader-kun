...
# ダウンロードボタン
download_button = tk.Button(root, text="ダウンロード", command=lambda: threading.Thread(target=download_video_thread, args=(url_entry, label, display_thumbnail, root)).start())
